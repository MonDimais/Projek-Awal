...
daftar room[31][16];
//untuk menghindari mentoknya data dan berhentinya kode
//jadi saya tulis 31 lantai dan 16 ruangan di arraynya
char pilihan;
...
void bantuan()
{
    ...
    cout << "\n\t\t\t\t## Ketik T untuk : Mencari nama pemesan kamar";
...
void pengunjung(string nama, string nama_b, int malam, int lantai, int kamar)
{
    string nama_p;
...
void data_k()
{
    ...
    int kamar;
        ...
        cout << "\t\t\t\t\tMasukkan lantai ke berapa : ";
        cin >> lantai;
...
void data_p() {
    ...
    cout << "\t\t\t\tSilahkan Isi Form ini untuk Mencari kamar tamu\n";
    cout << "\t\t\t\tIngin mencari kamar atas nama Siapa? ";
    cout << "\n\t\t\t\tMasukkan nama depan tamu yang ingin dicari : ";
    cin >> nama;
...
int main()
{
    ...
    while(true)
    {
...

        {
            ...
            harga(lantai, malam);
            pengunjung(nama, nama_b, malam, lantai, kamar);
            continue;
